...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image1.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image2.png)Even
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image3.png)

.6\*200+.4\*600 = 360 vs. 400 better go for the buy option.

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image4.png)![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image5.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image6.png)

Infer payouts
-------------

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image7.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image8.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image9.png)

How much would I pay to know that there is going to be a cashback
program?

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image10.png)

1.  Without information (I'm better of buying now with 0\$ pay off)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image11.png)

2.  With Information (I better rent and with a payoff of \$200)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image12.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image13.png)
...
![0\<=p\<=1](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image14.gif)and
an incorrect one with probability
![1-p](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image15.gif):

1\. If
![p\>1/2](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image16.gif)(so
...
2\. If
![p\<1/2](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image17.gif)(so
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image18.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image19.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image20.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image21.png)![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image22.png)![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image23.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image24.png)![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image25.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image26.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image27.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image28.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image29.png)![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image30.png)

Randomness
==========

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image31.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image32.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image33.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image34.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image35.png)

**Efficient Market Hypothesis helps explain although there may be some
deviations / challenges as noted in the critiques.**

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image36.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image37.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image38.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image39.png)

Different application of PD

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image40.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image41.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image42.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image43.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image44.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image45.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image46.png)

![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image47.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image48.png)
...
![](C:\scripts\dirkswiki\docs\Process_System_Models\media_Model_thinking/media/image49.png)
