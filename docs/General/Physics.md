...
-   $\frac{5m}{5ss}$=$\frac{1m}{\text{ss}}$ = 1m/s^2^
...
http://thehappyneuron.com/2020/12/there-are-no-green-stars/?utm\_source=rss&utm\_medium=rss&utm\_campaign=there-are-no-green-stars
